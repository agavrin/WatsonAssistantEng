...
=================
   ...
   * [Table of Contents](#table-of-contents)
      ...
      * [4.1. Import example flow configuration](#41-import-example-flow-configuration)
      * [4.2. Add Telegram controls to Node-RED](#42-add-telegram-controls-to-node-red)
      * [4.3. Configure Telegram in Node-RED](#43-configure-telegram-in-node-red)
      * [4.4. Configure connection to IBM Watson Assistant in Node-RED](#44-configure-connection-to-ibm-watson-assistant-in-node-red)
      * [4.5. Configure connection to Watson Visual Recognition in Node-RED](#45-configure-connection-to-watson-visual-recognition-in-node-red)
...
- Go to your WA instance, and click on the Service credentials tab. Make a note of key and URL:

<img width="700" src="images/wa-service-credentials.png"/>
...
## 4.1. Import example flow configuration
...
## 4.2. Add Telegram controls to Node-RED
...
## 4.3. Configure Telegram in Node-RED
...
## 4.4. Configure connection to IBM Watson Assistant in Node-RED
...
## 4.5. Configure connection to Watson Visual Recognition in Node-RED
