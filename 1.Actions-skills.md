...
* [3. Create Banking Assistant](#3-create-banking-assistant)
* [4. Create Actions skill](#4-create-actions-skill)
...
1.2. In the instance - select region closest to you (we will use **Frankfurt**), select **Plus trial** plan, enter Service name as "**Watson Assistant - Lab**" and click "Create":
...
2.2. Download banking dialog skill from <a href="https://github.ibm.com/agavrin/WatsonAssistantEN/raw/master/skills/skill-Banking-Dialog-EN.json">Github</a>. Click **Create Skill** button. Select **Dialog Skill**, click Next. Click **Upload Skill**. Select the downloaded file, click **Upload**.
